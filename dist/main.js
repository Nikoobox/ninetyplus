...
var renderGameById = function renderGameById() {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('./game').then(function (res) {
    ...
    oneGameContentDiv.append(fieldDiv); //adding players inside squads section - left of field
