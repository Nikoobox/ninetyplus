...
/* harmony import */ var _gamesRefresh__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./gamesRefresh */ "./src/scripts/gamesRefresh.js");
...
var renderGames = function renderGames(round) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("./games?round=".concat(round)).then(function (res) {
    ...
    fixturesArr.forEach(function (fix, idx) {
      ...
      var gameId = fix.fixture.id; // console.log(`gameStatus is: ${gameStatus}`)
      // to check if at leat one game is live to enable updates

      if (gameLiveStatus.includes(gameStatus)) liveGamesStatus = true; // console.log(liveGamesStatus)
    ...
    if (!liveGamesStatus) {
      ...
      Object(_gamesRefresh__WEBPACK_IMPORTED_MODULE_2__["default"])(btnLiveUpdates, btnNoLiveUpdates, round);
    } else {
...
var gamesRefresh = function gamesRefresh(btnLiveUpdates, btnNoLiveUpdates, round) {
  ...
  btnNoLiveUpdates.addEventListener('click', function () {
    ...
    console.log("clear int interval is ".concat(interval));
  });
};
