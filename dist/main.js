...
var renderVotingStat = function renderVotingStat(name1, name2, logo1, logo2, gameId) {
  ...
  modalVBox.innerHTML = "\n    ".concat(name1, " vs ").concat(name2, " : Vote for the winner! (work in progress ...)\n    ");
};
