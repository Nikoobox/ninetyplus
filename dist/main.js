      ...
      res.docs.forEach(function (doc) {
        ...
        if (parseInt(Object.keys(doc.data())[0]) === gameId) {
          ...
          if (num === 1) {
            ...
            updateData(_newData2, keyId, vote1, vote2);
            updated = true;
          }
        }
