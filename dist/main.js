...
var renderVotingStat = function renderVotingStat(name1, name2, logo1, logo2, gameId) {
  ...
  modalVBox.innerHTML = "\n        <div class='teams-row'>\n            <div class='btn-box'>\n                <button id='voteNum' name='name1'>".concat(name1, "</button>\n            </div>\n            <div class='message'> Who will win? </div>\n            <div class='btn-box'>\n                <button id='voteNum' name='name2'>").concat(name2, "</button>\n            </div>\n        </div>\n        <div class='voting-box'>\n            <div class='voting-box'>\n            </div>\n        </div>\n    ");
  var voteData = document.getElementById("voteNum");
  var val1 = 0;
  var val2 = 0;
  voteData.addEventListener('click', function (e) {
    console.log(e);
  ...
  var data = {}; // const trackDataChanges = () => {
  ...
  var writeData = function writeData(val, num) {// if (num === 1){
  ...
  var getData = function getData(num) {
    var data = {};
    db.collection('game-winner').get().then(function (res) {
